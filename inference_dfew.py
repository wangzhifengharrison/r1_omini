...
# python inference.py --modal video_audio   --model_path ./R1-Omni-0.5B   --video_path video_4_1_result.mp4   --instruct "As an emotional recognition expert; throughout the video, which emotion conveyed by the masked characters is the most obvious to you? Output the thinking process in <think> </think> and final emotion in <answer> </answer> tags."
